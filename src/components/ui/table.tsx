...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn('bg-panel border-b border-line', className)} {...props} />
));
...
const TableFooter = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLTableSectionElement>
>(({ className, ...props }, ref) => (
  <tfoot ref={ref} className={cn('bg-panel border-t border-line font-medium', className)} {...props} />
));
...
const TableRow = React.forwardRef<HTMLTableRowElement, React.HTMLAttributes<HTMLTableRowElement>>(
  ({ className, ...props }, ref) => (
    <tr
      ref={ref}
      className={cn(
        'hover:bg-panel transition-colors data-[state=selected]:bg-blue-50',
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-10 px-4 text-start align-middle text-[11.5px] font-semibold text-slate-500 whitespace-nowrap',
      className
    )}
    {...props}
  />
