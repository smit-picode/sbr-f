...
export const FRAME_FIELD_LABELS: Record<string, string> = {
...
export const FRAME_SOURCE_CODE_OPTIONS: string[] = ['MOCI', 'QFC', 'QFZ', 'QSTP', 'MOM_FARM'];

// Max length validations from backend validator
export const FRAME_MAX_LENGTHS: Record<string, number> = {
  NAME_ENU: 500,
  NAME_ARA: 500,
  NAME_ENU_SOURCE: 50,
  NAME_ARA_SOURCE: 50,
...
export const FRAME_DEFAULT_FILTERS = {
  page: 1,
  limit: 20,
  search: '',
  estStatus: '',
